...
<meta charset="UTF-8">
<title>Quotation <?php echo e($order->quote_number); ?></title>
<style>
...
<div class="top">
  <div><img src="/img/smartept-logo-h-light.png" alt="SmartEPT by Ametecs" style="height:42px;width:auto;display:block;margin-bottom:8px"><h1>QUOTATION</h1>
    <div style="font-size:12px;color:#565A66"><?php echo e($order->quote_number); ?> · <?php echo e($order->created_at->format('d M Y')); ?> · valid 15 days</div></div>
  <div class="co"><b style="color:#15171C;font-size:13px"><?php echo e($company['name']); ?></b><br>
    <?php echo e($company['address']); ?><br>GSTIN: <?php echo e($company['gstin']); ?><br><?php echo e($company['phone']); ?> · <?php echo e($company['email']); ?></div>
</div>
<div class="meta">
  <div class="box"><b>Quoted To</b><?php echo e($order->tenant->company_name); ?><br>
    <?php echo e($order->tenant->address); ?><br>
    <?php if($order->tenant->gstin): ?> GSTIN: <?php echo e($order->tenant->gstin); ?><br><?php endif; ?>
    <?php echo e($order->tenant->email); ?> · <?php echo e($order->tenant->phone); ?></div>
  <div class="box"><b>Quotation Details</b>Reference order: <?php echo e($order->number); ?><br>
    <?php if($order->requested_by): ?> Requested by: <?php echo e($order->requested_by); ?><br><?php endif; ?>
    Status: <?php echo e($order->status === 'quote' ? 'AWAITING MANAGEMENT APPROVAL' : strtoupper($order->status)); ?></div>
</div>
<?php
...
<table>
  ...
  <?php $__currentLoopData = $order->line_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  <tr><td><?php echo e($line['description']); ?></td><td><?php echo e($line['sac'] ?? $sac); ?></td><td><?php echo e($line['qty'] ?? 1); ?></td>
  <td style="text-align:right"><?php echo e($order->currency === 'INR' ? '₹' : '$'); ?><?php echo e(number_format($line['amount'], 2)); ?></td></tr>
  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</table>
<div class="tots">
  <div class="r"><span>Subtotal</span><span><?php echo e($order->currency === 'INR' ? '₹' : '$'); ?><?php echo e(number_format($order->subtotal, 2)); ?></span></div>
  <div class="r"><span>GST<?php echo e($order->currency === 'INR' ? ' @ ' . rtrim(rtrim(number_format((float) \App\Models\Setting::get('gst_rate', 18), 2), '0'), '.') . '%' : ''); ?></span><span><?php echo e($order->currency === 'INR' ? '₹' : '$'); ?><?php echo e(number_format($order->tax_amount, 2)); ?></span></div>
  <div class="r g"><span>Total</span><span><?php echo e($order->currency === 'INR' ? '₹' : '$'); ?><?php echo e(number_format($order->total, 2)); ?></span></div>
</div>
...
<div style="margin-top:10px;background:#FAFBFC;border:1px solid #E7E9EF;border-radius:9px;padding:9px 12px;font-size:11.5px">
  <b style="color:#0B6373">Amount in words:</b> <?php echo e(\App\Support\AmountInWords::convert((float) $order->total)); ?></div>
<p style="margin-top:8px;font-size:11px;color:#878C99">GST 18% under SAC <?php echo e($sac); ?> (software licensing). The tax invoice issued on payment
...
<div class="payline"><b>For Management — approve &amp; pay online:</b>
  <?php echo e($payUrl); ?><br>UPI · Cards · NetBanking (Razorpay) or international card (Stripe). Payment activates the licence instantly and the GST tax invoice is issued automatically. Bank transfer (NEFT/UPI) is equally welcome — share the UTR on WhatsApp 90000 98877.</div>
...
<div class="foot">
  <span>SmartEPT — Employee Productivity Tracking & Intelligence · by <?php echo e($company['name']); ?></span>
  <span>This is a computer-generated quotation.</span>
</div>
</body>
</html>
<?php /**PATH C:\laragon\www\smartept-central\resources\views/quote-print.blade.php ENDPATH**/ ?>