...
<title><?php echo e($user->tenant->company_name); ?> — SmartEPT Client Portal</title>
<style>
...
<aside>
  ...
  <div class="side-foot">
    <div class="me">
      ...
      <div class="me-id"><b><?php echo e($user->name); ?></b><span><?php echo e($user->tenant->company_name); ?></span></div>
      <form method="POST" action="/client/logout"><?php echo csrf_field(); ?><button type="submit">Logout</button></form>
    </div>
  </div>
</aside>
...
<?php if($user->must_set_password ?? false): ?>
...
<div class="overlay show" id="forcePwOv" style="z-index:70">
  <div class="modal" style="max-width:440px">
    ...
    <p class="mini" style="margin-bottom:12px">Welcome, <?php echo e($user->name); ?>! You signed in with a temporary password.
...
async function pgAccount() {
  ...
  <div class="card">
    <h3>Signed in as</h3>
    <p class="mini" style="line-height:1.8"><b style="color:var(--ink)"><?php echo e($user->name); ?></b> · <?php echo e($user->email); ?><br>
    Company: <b style="color:var(--ink)"><?php echo e($user->tenant->company_name); ?></b></p>
  </div>
...
<?php /**PATH C:\laragon\www\smartept-central\resources\views/client/portal.blade.php ENDPATH**/ ?>