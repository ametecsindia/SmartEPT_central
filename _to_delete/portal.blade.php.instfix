...
async function pgInstall() {
  ...
  <div class="card" style="margin-bottom:16px">
    ...
    <p class="mini">Enter this key during installation to activate SmartEPT on your infrastructure. It ties your servers and agents to your account for licensing only — no monitoring data ever leaves your network.</p>
  ...
  <div class="dgrid">
    <div class="card dcard">
      ...
      <p class="mini">The management server your team logs into and where all monitoring data is stored — on your own infrastructure. The installer bundles everything it needs (runtime + database) and sets up the console at <b>http://your-server/admin</b>.</p>
      <ol class="steps">
    ...
    <div class="card dcard">
      ...
      <p class="mini">The lightweight agent that runs on employee workstations — attendance-linked access, activity, app &amp; website usage. Deploy it to each PC; it registers to your Admin Server and consumes one device seat.</p>
      <ol class="steps">
        <li>Install the Admin Server first (above).</li>
        <li>Run this installer on each employee PC (or push it via your IT tools).</li>
        <li>Set the Server URL to your Admin Server address; the employee signs in and consents.</li>
  ...
  <div class="card" style="margin-top:16px">
    <h3>Need help deploying?</h3>
    <p class="mini">Our team can install and configure SmartEPT for you remotely, or walk your IT team through it. WhatsApp <a class="link" href="https://wa.me/919000098877" target="_blank">90000 98877</a> or email <a class="link" href="mailto:sales@ametecsindia.com">sales@ametecsindia.com</a>.</p>
  </div>`;
}
function installSoon(art) {
  const label = art === 'admin' ? 'the Admin Server installer' : 'the Employee Agent installer';
