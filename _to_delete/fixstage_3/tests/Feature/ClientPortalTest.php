...
class ClientPortalTest extends TestCase
{
    ...
    {
        // Throttle counters share one signature per IP across routes — earlier
        // tests' hits can push this multi-step flow over the 5/min OTP limit,
        // so rate limiting is switched off for this test only.
